    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('agreeTerms', CheckboxType::class, [
                'label' => 'En cochant cette case, je reconnais avoir pris connaissance des <a>Conditions Générales d\'Utilisation</a> du site ainsi que sa <a>Politique de Confidentialité</a> et je les accepte.',
                'label_html' => true,
                'mapped' => false,
                'constraints' => [
                    new IsTrue([
